...
class UserProviderStore {
  late final UserStorageInterface localStore;
  ...
  late final ValueListenable<Box<User>> localStoreListenable;

  UserProviderStore(
      {SyncStorageInterface? syncStore,
      UserStorageInterface? localStore,
    ...
    this.localStore = localStore ?? Modular.get<UserStorageInterface>();
  ...
  Future<bool> delete(User stAssist) async {
