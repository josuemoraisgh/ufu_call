...
part 'students_models.g.dart';

@HiveType(typeId: 2, adapterName: 'StudentsAdapter')
class Students extends HiveObject {
  ...
  Students.assistido(Students assistido)
  ...
  factory Students.fromList(List<dynamic> value) {
